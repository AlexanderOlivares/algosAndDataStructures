const reverseOnlyLetters = require("./lcReverseOnlyLetters");
const reverseOnlyLetters2 = require("./lcReverseOnlyLetters");
...
test("reverseOnlyLetters solution 2", () => {
  ...
  expect(reverseOnlyLetters2("Test1ng-Leet=code-Q!")).toEqual(
    "Qedo1ct-eeLg=ntse-T!"
  );
